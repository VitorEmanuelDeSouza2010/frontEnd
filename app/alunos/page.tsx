    ...
    return (
        <div className="w-screen h-screen text-3xl flex flex-col items-center">
            ...
            <div className="w-[90%] h-100 bg-white rounded-md shadow-md shadow-white text-black p-2 overflow-auto">
                <ul className="bg-gray-400 border rounded flex flex-col items-center gap-2">
                    {alunos.map((aluno) => (
                        <AlunoItem
                        key={aluno.id}
                        nome={aluno.nome}
            ...
            <Link href="/aluno/cadastro" className="px-5 py-2 bg-white shadow-md shadow-white text-black mt-5 rounded-lg">
            Cadastrar aluno
            </Link>
        </div>
    );
